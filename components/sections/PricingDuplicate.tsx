          ...
          >
            {pricingTiers.map((tier, index) => (
              <motion.div
                ...
                className="bg-black border border-red-500/30 rounded-lg p-4 sm:p-6 hover:border-red-500/60 transition-all duration-300 mx-2 sm:mx-0 min-h-24 flex items-center"
              >
